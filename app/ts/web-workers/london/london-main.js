System.register(['angular2/core', 'angular2/platform/worker_render'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            core_1.platform([worker_render_1.WORKER_RENDER_PLATFORM]).application([worker_render_1.WORKER_RENDER_APPLICATION, new core_1.Provider(worker_render_1.WORKER_SCRIPT, { useValue: "./london/london-loader.ts" })]);
        }
    }
});
